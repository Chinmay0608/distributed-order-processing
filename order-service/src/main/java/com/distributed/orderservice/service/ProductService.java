...
public class ProductService {
    ...
    public static List<Product> getDefaultCatalog() {
        return List.of(
                // Phones
                new Product("prod-iphone-15-pro", "Apple iPhone 15 Pro", "128GB Natural Titanium (High Contention SKU)", "Phones", 999.00, 1),
                ...
                new Product("prod-book-system-design", "System Design Interview (Vol 1 & 2)", "Alex Xu - Distributed systems and scalability patterns", "Books", 39.99, 35),
                ...
                // Hardware & Audio
                new Product("prod-sony-wh1000xm5", "Sony WH-1000XM5 Headphones", "Wireless Noise Cancelling Headphones (Single-Unit Inventory)", "Hardware", 349.99, 1),
